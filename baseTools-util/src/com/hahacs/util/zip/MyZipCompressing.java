...
public class MyZipCompressing {  
  ...
  public MyZipCompressing() {  
      // TODO Auto-generated constructor stub  H:\03中间数据\账户余额\zip
	  System.out.println("用的是jdk自带的解压功能");
  }  
  ...
  public static void main(String[] args) {  
      ...
      try {  
          book.zip("H:\\03中间数据\\账户余额\\zip\\20160919_zhye-yh-cqg.zip",  
                  new File("H:\\03中间数据\\账户余额\\csv"));  
      } catch (Exception e) {  
